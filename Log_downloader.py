...
# -----------------------------------------------------------------------------
sensor_addresses = [
    "F8:DC:C7:F1:48:7A", "FC:97:E9:E0:E8:E4", "F7:68:55:8D:84:0E", "E6:4F:B9:D7:18:7C", "F4:73:A1:AB:BB:64"
]
# sensor_addresses = [
#     "F4:73:A1:AB:BB:64"
# ]
...
class State:
    ...
    def start_loggers(self):
        b = self.board
        # minInterval = 750 ms, maxInterval = 1000 ms, latency = 128, timeout = 16384 (ms)
        libmetawear.mbl_mw_settings_set_connection_parameters(
            b, 750.0, 1000.0, 128, 16384
        )
        time.sleep(0.1)

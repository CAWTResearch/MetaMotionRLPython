...
import subprocess, time, datetime, os, csv, signal, sys, threading
...
device_macs = ["CE:5A:39:E6:8F:B3", "F0:3D:E7:ED:F6:F7", "E6:AC:5E:B8:4C:D9",  "D5:42:DD:AC:BE:E1", "E6:4F:B9:D7:18:7C"]
...
profiles = [
    ...
    {"interval":7.5, "latency":0, "timeout":20000, "offset":40},
]
